<template>
  <div>
    <div
        class="flex flex-col px-4 md:py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl lg:flex-row">
      <div class="mb-5 lg:w-1/3 lg:mb-0 lg:mr-20">
        <h2 class="relative mb-4 font-sans text-2xl font-bold tracking-tight text-gray-900 sm:leading-none">
        <span class="relative inline-block">
          ...
          <span class="relative">Languages,</span>
        </span>
          technologies and tools
        </h2>
        <p class="mb-4 text-gray-900 lg:mb-6">
          I like a challenge, which is why I regularly try out new programming languages and techniques. Curious about
          my public projects? Have a look at my GitHub profile.
        </p>
        <a href="https://github.com/stijntersteege"
           class="inline-flex items-center font-semibold transition-colors duration-200 text-blue-accent-400 hover:text-blue-800">
          Visit my GitHub
      ...
      <div class="flex-grow pt-1">
        <div class="flex items-center mb-3">
          <span class="font-bold tracking-wide text-gray-900">Tech Stack</span>
          <span class="ml-1">
          <svg class="w-5 h-5 mt-px text-blue-accent-400" stroke="currentColor" viewBox="0 0 52 52">
        ...
        <div class="grid grid-cols-2 row-gap-6 sm:grid-cols-4">
          ...
          <ul class="pt-2 sm:pt-0 space-y-2">
            <li class="flex gap-x-1">
              Angular
              <svg viewBox="0 0 128 128" class="w-6 h-6">
                <path fill="#B3B3B3"
                      d="M63.81 1.026L4.553 21.88l9.363 77.637 49.957 27.457 50.214-27.828 9.36-77.635z"></path>
                ...
                <path fill="#F2F2F2"
                      d="M78.499 67.67l-14.827 6.934H48.044l-7.347 18.374-13.663.254 36.638-81.508L78.499 67.67zm-1.434-3.491L63.77 37.858 52.864 63.726h10.807l13.394.453z"></path>
                <path fill="#B3B3B3"
          ...
          <ul class="pt-2 sm:pt-0 space-y-2">
            <li class="flex gap-x-1">
              Tailwind
              <svg viewBox="0 0 248 31" class="text-slate-900 dark:text-white w-24 h-auto">
